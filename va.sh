...
train_cat_sample_dbg() {
    gpuid=0
    seed=3435
    name=model_cat_sample_dbg
    python train.py \
        -data $DATA \
        -save_model $name -gpuid $gpuid -seed $seed \
        -mode sample \
...
train_cat_sample_dbg_fast() {
        #-use_generative_model 1 \
    gpuid=0
    seed=3435
    name=model_cat_sample_dbg_fast
    python train.py \
        -data $DATA \
        -save_model $name -gpuid $gpuid -seed $seed \
        -mode sample \
...
train_cat_sample_dbg_fast_smalltgt() {
    ...
    gpuid=0
    seed=3435
    name=model_cat_sample_dbg_fast_smalltgt
    python train.py \
        -data $DATA \
        -save_model $name -gpuid $gpuid -seed $seed \
        -mode sample \
        ...
        -inference_network_type bigbrnn \
        -inference_network_src_rnn_size 512 \
        -inference_network_tgt_rnn_size 256 \
        -src_word_vec_size 512 \
        -tgt_word_vec_size 512 \
        -memory_size 1024 \
        -decoder_rnn_size 768 \
